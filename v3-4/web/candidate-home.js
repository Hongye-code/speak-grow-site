...
const profileTracks = { interview: "workplace", workplace: "workplace", improv: "workplace", smalltalk: "workplace", story: "workplace", speech: "ideas", topic: "ideas" };
const routes = {
  workplace: [
    { code: "SOCIAL", icon: "◌", name: "闲聊训练", detail: "破冰、倾听、自然回应", profile: "smalltalk", topic: "" },
    ...
    { code: "STORY", icon: "◇", name: "讲故事", detail: "变化、判断、真实证据", profile: "story", topic: "我需要把一次推进卡住后重新向前的经历，讲成有主线的故事。" }
  ],
  ideas: [
