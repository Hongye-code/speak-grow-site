...
const profileGuidance = {
  ...
  smalltalk: { audience: "正在和你轻量交流的同事", standard: "一个具体观察、对对方原话的回应，以及留白的轻量问题", firstAction: "先接住对方刚说的一个关键词，再问一个容易回答的小问题。" },
  story: { audience: "需要理解你经历价值的听众", standard: "前后变化、关键判断、一个真实细节和当前价值", firstAction: "第一句先说发生了什么变化，再只保留一个证明变化的真实细节。" }
};
