...
export const profileRegistry = [
  { id: "interview", order: 1, code: "CAREER", name: "求职面试", icon: "◎", shortSummary: "结果 + 证据", title: "把价值讲具体", summary: "先给出结果，再用你的选择和证据证明价值。", goals: ["先讲结果", "说清自己的作用", "给出可验证证据"], steps: ["先说最后创造的变化。", "说明你的关键判断。", "留下一个可核验细节。"], scenes: interviewScenes, capabilities: { audioDownload: true } },
  { id: "workplace", order: 2, code: "DEFAULT", name: "职场表达", icon: "↗", shortSummary: "范围 + 优先级", title: "尊重自己的时间", summary: "先讲清你已承诺的事，再给出你能支持的范围，让优先级回到该决定的人手里。", goals: ["先说可支持范围", "讲清已有承诺", "把优先级交回去"], steps: ["先说你能支持什么。", "说明完整接手会影响什么。", "请对方确认优先级。"], scenes: workplaceScenes, capabilities: { audioDownload: true } },
  { id: "speech", order: 3, code: "IDEA", name: "深度演讲", icon: "✦", shortSummary: "观点 + 例子", title: "让观点站得住", summary: "用一个明确判断开场，再用熟悉例子把观点落到现实。", goals: ["先抛出观点", "用一个证据支撑", "留下可行动的结尾"], steps: ["第一句说判断。", "只选一个有力例子。", "留下今天能做的一步。"], scenes: speechScenes, capabilities: { audioDownload: true } },
  { id: "topic", order: 4, code: "CLARITY", name: "主题表达", icon: "▣", shortSummary: "抽象 → 具体", title: "把复杂想法说简单", summary: "先把抽象概念换成身边场景，再给听众一句可复述结论。", goals: ["把主题说简单", "举一个具体例子", "形成清楚收束"], steps: ["先用真实小事起头。", "一次只说一个逻辑台阶。", "用一句可复述的话结尾。"], scenes: topicScenes, capabilities: { audioDownload: true } },
  ...
  { id: "smalltalk", order: 6, code: "SOCIAL", name: "职场闲聊", icon: "◌", shortSummary: "观察 + 接住", title: "自然地让交流继续", summary: "从一个具体细节开始，接住对方原话，再给对方继续表达的空间。", goals: ["先说一个具体观察", "接住对方关键词", "留出继续表达的空间"], steps: ["只从眼前一个细节开场。", "先回应对方，再补自己的经验。", "用一个轻量问题把话交回去。"], scenes: smalltalkScenes, capabilities: { audioDownload: true } }
