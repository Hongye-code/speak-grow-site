...
const expectedIds = ["interview", "workplace", "speech", "topic", "improv", "smalltalk"];
...
console.log("profiles: 6 boards x 100 unique scenes; every training supports local WebM download");
